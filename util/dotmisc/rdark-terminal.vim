...
hi Normal term=NONE cterm=NONE ctermbg=0 ctermfg=250
...
hi NonText term=bold cterm=NONE ctermbg=bg ctermfg=236
...
hi Identifier term=underline cterm=NONE ctermbg=bg ctermfg=116
...
hi LineNr term=underline cterm=NONE ctermbg=16 ctermfg=234
hi ExtraWhitespace term=NONE cterm=NONE ctermbg=bg ctermfg=fg
hi Visual term=reverse cterm=NONE ctermbg=189 ctermfg=16
...
hi TabLineFill term=reverse cterm=NONE ctermbg=234 ctermfg=16
hi CursorColumn term=NONE cterm=NONE ctermbg=bg ctermfg=242
hi Cursor term=NONE cterm=NONE ctermbg=140 ctermfg=16
...
hi FoldeColumn term=NONE cterm=NONE ctermbg=bg ctermfg=bg
hi Question term=NONE cterm=NONE ctermbg=bg ctermfg=113
hi Title term=bold cterm=bold ctermbg=bg ctermfg=255
...
hi Folded term=NONE cterm=NONE ctermbg=236 ctermfg=250
...
hi FoldColumn term=NONE cterm=NONE ctermbg=bg ctermfg=bg
